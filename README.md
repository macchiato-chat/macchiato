...
- 🤖 **Agent-first** — connectors for [Hermes](https://github.com/NousResearch), [OpenClaw](https://openclaw.ai), [Claude Code](https://claude.com/claude-code) and [Codex](https://developers.openai.com/codex), one-line install for all
